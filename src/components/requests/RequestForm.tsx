...
import { HardwareRequestData, SoftwareRequestData, MachineShopRequestData, BatteryChargingRequestData, RequestType } from '@/lib/types';
...
export default function RequestForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    switch (type) {
      case 'hardware':
        data.hardware = serializeHardwareData(formData);
        break;
      case 'software':
        data.software = serializeSoftwareData(formData);
        break;
      case 'machine_shop':
        data.machine_shop = serializeMachineShopData(formData);
        break;
      case 'battery_charging':
        data.battery_charging = serializeBatteryChargingData(formData);
        break;
    }
